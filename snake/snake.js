$(document).ready(function(){
	...
	{
		//console.log("create_food called");
		generate_image();
		food = {
		...
		//pokeball.style.top =Math.round(Math.random()*(w-cw)/cw);
	  //	pokeball.style.left= Math.round(Math.random()*(h-cw)/cw);
	...
	function paint_food(x, y)
	{
		ctx.fillStyle = "blue";
		ctx.fillRect(x*cw, y*cw, cw, cw);
		ctx.drawImage(img,cw*x,cw*y,cw,cw);
		//ctx.fillRect(x*cw, y*cw, cw, cw);
	}
