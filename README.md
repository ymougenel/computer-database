...
Computer-database is a training project done during my internship (in mars 2016).

The application is made with the following technologies: Maven multi-module, Tomcat, Spring, Docker, Jenkins, Hibernate.

The Frameworks/librairies are included step by step during the process. Each integration is concluded with a code review.
## Application purpose
